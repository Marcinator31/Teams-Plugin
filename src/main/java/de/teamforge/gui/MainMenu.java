...
public class MainMenu extends AbstractMenu {
    ...
    private TagResolver[] infoPlaceholders() {
        ...
        return new TagResolver[]{
                ...
                Placeholder.unparsed("ff", plugin.getMessages().onOff(team.isFriendlyFire())),
                Placeholder.unparsed("open", plugin.getMessages().onOff(team.isOpen())),
    ...
    protected void build() {
        ...
        setItem(21, ItemBuilder.of(Material.PAPER)
                ...
                .lore(Collections.singletonList(plugin.getMessages().get("gui.main.chat.state",
                        Placeholder.unparsed("state", plugin.getMessages().onOff(
