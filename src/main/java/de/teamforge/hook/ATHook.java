...
public class ATHook {
    ...
    private static final String RESERVED_HOME = "Teamhome";
    ...
    private Method mRemoveHome;

    /** Old reserved name from earlier versions, cleaned up on first use. */
    private static final String LEGACY_HOME = "tfteamhome";
    ...
    public boolean setup() {
        ...
        try {
            ...
            mRemoveHome = atPlayer.getMethod("removeHome", String.class,
                    org.bukkit.command.CommandSender.class);
            active = true;
    ...
    public boolean teleportToTeamHome(Player player, Location home) {
        ...
        try {
            ...
            // Remove leftover home from older versions, if present.
            try {
                if ((Boolean) mHasHome.invoke(atPlayer, LEGACY_HOME)) {
                    mRemoveHome.invoke(atPlayer, LEGACY_HOME, player);
                }
