...
import de.teamforge.hook.ATHook;
...
import de.teamforge.manager.GlowService;
...
public class TeamForgePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.glowService = new GlowService(this);
        this.chatService = new ChatService(this);
        this.chatInputService = new ChatInputService(this);
        this.atHook = new ATHook(this);
        this.atHook.setup();
        ...
        if (glowService.isActive()) {
            getServer().getScheduler().runTaskTimer(this, glowService::refreshAll, 40L, 20L);
        }
    ...
    public GlowService getGlowService() {
        return glowService;
    }
