...
public class TeleportService {
    ...
    public void startHome(Player player, Team team) {
        ...
        // If AdvancedTeleport is present, let it handle warmup + countdown.
        if (plugin.getATHook() != null && plugin.getATHook().isActive()) {
            if (plugin.getATHook().teleportToTeamHome(player, home)) {
                return;
            }
        }
